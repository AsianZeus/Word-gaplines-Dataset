...
pathx = 'C:/Users/akroc/Desktop/eer'
...
for name in filename:
    ...
    for c in components:
        ...
        cv.waitKey(0)
        # cv.imwrite(f"C:/Users/akroc/Desktop/AI and ML/PIRDS/Dataset/ProcessedWords/{name}_{wordcounter}.png",currImg)
        # quit()
...
# pathx = 'C:/Users/akroc/Desktop/AI and ML/PIRDS/Dataset/ProcessedLines'
# filename = os.listdir(pathx)
# for name in filename:
#     newpath= pathx+'/'+name
