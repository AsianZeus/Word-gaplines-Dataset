...
if __name__ == "__main__":
    #     try:
    #         cseg=CharSegmentation.Model('C:/Users/akroc/Desktop/AI and ML/PIRDS/ocr-handwriting-models/gap-clas/RNN/Bi-RNN-new', 'prediction')
    ...
    # ************ FourPointPerspective (Region of Interest) *******************
            ...
            # cv.waitKey(0)
            cv.imwrite(
                f'{path}/CroppedImage/{name[:-4]}.png', FourPointPerspectiveImage)
