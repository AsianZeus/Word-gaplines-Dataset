...
def textDetectWatershed(thresh):
    ...
    implt(image)
import os
filename= os.listdir('C:/Users/akroc/Desktop/Dataset/Lines')

for name in filename:
    file='C:/Users/akroc/Desktop/Dataset/Lines/'+name
    print(file)
    SegmentedLine =cv2.imread(file)
    detection(SegmentedLine)