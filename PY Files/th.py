...
# import os
# filename= os.listdir('C:/Users/akroc/Desktop/Dataset/Words')
# i=0
# for name in filename:
#     file='C:/Users/akroc/Desktop/Dataset/Words/'+name
#     print(file)
#     SegmentedWord =cv2.imread(file)
#     cv2.namedWindow("ssp0",0)
#     cv2.imshow("ssp0",SegmentedWord)
#     cv2.waitKey()
#     img=word_normalization(SegmentedWord,60,hyst_norm=True)
#     cv2.namedWindow("ssp",0)
#     cv2.imshow("ssp",img)
#     cv2.waitKey()
