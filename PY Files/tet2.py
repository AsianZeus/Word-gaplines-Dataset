...
pathx = 'C:/Users/akroc/Desktop/Dataset/Words'
...
for name in filename:
	...
	res = wordSegmentation(gray, kernelSize=5, sigma=0.1, theta=0.2, minArea=300)
	...
	for (j, w) in enumerate(res):
		...
		cv.imwrite(f'C:/Users/akroc/Desktop/Dataset/NewWords/{name[:-4]}_{j}.png', currImg)
		# cv.rectangle(lcropped,(x,y),(x+w,y+h),0,1)
